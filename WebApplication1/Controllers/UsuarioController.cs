...
namespace WebApplication1.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        {
            if(usuario.Login == "admin" && usuario.Senha == "admin") return new OkObjectResult(new Item { tipo = "admin" });
            ...
            if (LoginExists(usuario.Login, usuario.Senha))
            {
                ...
                if(u.Admin == true) return new OkObjectResult(new Item { tipo = "admin" });
                if (u.NDE == true) return new OkObjectResult(new Item { tipo = "nde" });
                return new OkObjectResult(new Item { tipo = "professor" });
